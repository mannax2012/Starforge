...
public:
	...
	int doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
		...
		suiTrainerType->addMenuItem("@city/city:st_mineralogist", 21);
		suiTrainerType->addMenuItem("@city/city:st_musician", 22);
		suiTrainerType->addMenuItem("@city/city:st_pistol", 23);
		suiTrainerType->addMenuItem("@city/city:st_polearm", 24);
		suiTrainerType->addMenuItem("@city/city:st_politician", 25);
		suiTrainerType->addMenuItem("@city/city:st_ranger", 26);
		suiTrainerType->addMenuItem("@city/city:st_rifleman", 27);
		suiTrainerType->addMenuItem("@city/city:st_scout", 28);
		suiTrainerType->addMenuItem("@city/city:st_smuggler", 29);
		suiTrainerType->addMenuItem("@city/city:st_squadleader", 30);
		suiTrainerType->addMenuItem("@city/city:st_2hsword", 31);
		suiTrainerType->addMenuItem("@city/city:st_tailor", 32);
		suiTrainerType->addMenuItem("@city/city:st_unarmed", 33);
		suiTrainerType->addMenuItem("@city/city:st_weaponsmith", 34);
