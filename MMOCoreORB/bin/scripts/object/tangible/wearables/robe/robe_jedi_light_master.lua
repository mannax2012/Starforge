...
object_tangible_wearables_robe_robe_jedi_light_master = object_tangible_wearables_robe_shared_robe_jedi_light_master:new {
...
ObjectTemplates:addTemplate(object_tangible_wearables_robe_robe_jedi_light_master, "object/tangible/wearables/robe/robe_jedi_light_master.iff")
