object_draft_schematic_clothing_clothing_bracer_tusken_raider_r_schematic = object_draft_schematic_clothing_shared_clothing_bracer_tusken_raider_r_schematic:new {
   ...
   targetTemplate = "object/tangible/wearables/bracer/clothing_crafted_tusken_raider_bracer_r.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_bracer_tusken_raider_r_schematic, "object/draft_schematic/clothing/clothing_bracer_tusken_raider_r_schematic.iff")
