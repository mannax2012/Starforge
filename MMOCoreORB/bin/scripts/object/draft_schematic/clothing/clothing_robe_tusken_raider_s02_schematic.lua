object_draft_schematic_clothing_clothing_robe_tusken_raider_s02_schematic = object_draft_schematic_clothing_shared_clothing_robe_tusken_raider_s02_schematic:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,
   customObjectName = "Tusken Raider Robes (Style 2)",
   ...
   targetTemplate = "object/tangible/wearables/robe/robe_tusken_raider_s02.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_robe_tusken_raider_s02_schematic, "object/draft_schematic/clothing/clothing_robe_tusken_raider_s02_schematic.iff")
