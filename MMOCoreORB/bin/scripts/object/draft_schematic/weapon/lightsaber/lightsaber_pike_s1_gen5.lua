...
object_draft_schematic_weapon_lightsaber_lightsaber_pike_s1_gen5 = object_draft_schematic_weapon_lightsaber_shared_lightsaber_pike_s1_gen5:new {
   ...
   targetTemplate = "object/weapon/melee/polearm/crafted_saber/sword_lightsaber_pike_s1_gen5.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_weapon_lightsaber_lightsaber_pike_s1_gen5, "object/draft_schematic/weapon/lightsaber/lightsaber_pike_s1_gen5.iff")
