...
object_draft_schematic_vehicle_civilian_landspeeder_ab1_crafted = object_draft_schematic_vehicle_civilian_shared_landspeeder_ab1_crafted:new {
	...
	targetTemplate = "object/tangible/deed/vehicle_deed/landspeeder_ab1_crafted_deed.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_vehicle_civilian_landspeeder_ab1_crafted, "object/draft_schematic/vehicle/civilian/landspeeder_ab1_crafted.iff")
