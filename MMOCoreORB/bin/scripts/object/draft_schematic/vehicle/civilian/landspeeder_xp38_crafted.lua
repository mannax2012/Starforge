...
object_draft_schematic_vehicle_civilian_landspeeder_xp38_crafted = object_draft_schematic_vehicle_civilian_shared_landspeeder_xp38_crafted:new {
	...
	targetTemplate = "object/tangible/deed/vehicle_deed/landspeeder_xp38_crafted_deed.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_vehicle_civilian_landspeeder_xp38_crafted, "object/draft_schematic/vehicle/civilian/landspeeder_xp38_crafted.iff")
