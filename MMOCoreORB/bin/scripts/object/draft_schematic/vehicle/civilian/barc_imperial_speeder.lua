...
object_draft_schematic_vehicle_civilian_barc_imperial_speeder = object_draft_schematic_vehicle_civilian_shared_barc_imperial_speeder:new {
	...
	targetTemplate = "object/tangible/deed/vehicle_deed/barc_speeder_imperial_crafted_deed.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_vehicle_civilian_barc_imperial_speeder, "object/draft_schematic/vehicle/civilian/barc_imperial_speeder.iff")
