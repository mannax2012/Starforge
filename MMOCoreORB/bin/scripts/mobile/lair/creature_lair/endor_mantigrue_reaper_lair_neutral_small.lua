endor_mantigrue_reaper_lair_neutral_small = Lair:new {
	mobiles = {{"mantigrue_reaper",1}},
	spawnLimit = 15,
...
addLairTemplate("endor_mantigrue_reaper_lair_neutral_small", endor_mantigrue_reaper_lair_neutral_small)
