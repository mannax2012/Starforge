band_fanfar_outfit = {
	{ 
		{objectTemplate = "object/tangible/wearables/shirt/shirt_s05.iff", customizationVariables = {{"/private/index_color_1", 90}} },
...
addOutfitGroup("band_fanfar_outfit", band_fanfar_outfit)
