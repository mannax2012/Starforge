...
mirla_2 = ConvoScreen:new {
	id = "mirla_2",
	leftDialog = "@theme_park/warren/warren:mirla_2", -- My husband is.... dead? Oh no... I should have known. That madman Teraud, this is all his fault. Thank you for delivering his letter to me. But please, you have to take him down!
	stopConversation = "false",
	options = {
		{"@theme_park/warren/warren:mirla_1_reply_2", "mirla_3"}, -- Don't worry.
