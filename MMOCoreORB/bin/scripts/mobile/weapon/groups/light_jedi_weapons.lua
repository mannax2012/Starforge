light_jedi_weapons = {
	...
	"object/weapon/melee/2h_sword/crafted_saber/sword_lightsaber_two_handed_s9_gen4.iff",
	"object/weapon/melee/polearm/crafted_saber/sword_lightsaber_polearm_s2_gen4.iff"
}
